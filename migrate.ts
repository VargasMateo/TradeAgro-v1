...
async function migrate() {
  ...
  try {
    ...
    const clientMappings = [
        ...
        { old: 'direccion', new: 'address', type: 'VARCHAR(255)' },
    ...
    const obsClientCols = ['id_cliente', 'razon_social', 'iva', 'telefono', 'direccion', 'is_deleted', 'deleted_at', 'created_by', 'created_at', 'estado'];
